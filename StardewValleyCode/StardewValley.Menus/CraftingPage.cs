...
namespace StardewValley.Menus
{
	public class CraftingPage : IClickableMenu
	{
		...
		private void clickCraftingRecipe(ClickableTextureComponent c, bool playSound = true)
		{
			...
			else if (this.heldItem.Name.Equals(item.Name) && this.heldItem.Stack + this.pagesOfCraftingRecipes[this.currentCraftingPage][c].numberProducedPerCraft - 1 < this.heldItem.maximumStackSize())
			{
