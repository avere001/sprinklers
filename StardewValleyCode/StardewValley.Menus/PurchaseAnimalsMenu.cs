		...
		public static string getAnimalTitle(string name)
		{
				...
				if (num != 292886277u)
				{
					if (num != 613168024u)
					{
						if (num == 889009852u)
						{
							if (name == "Chicken")
							{
								return Game1.content.LoadString("Strings\\StringsFromCSFiles:Utility.cs.5922", new object[0]);
							}
						}
					}
					else if (name == "Duck")
					{
						return Game1.content.LoadString("Strings\\StringsFromCSFiles:Utility.cs.5937", new object[0]);
					}
				}
				else if (name == "Rabbit")
				{
					return Game1.content.LoadString("Strings\\StringsFromCSFiles:Utility.cs.5945", new object[0]);
				}
			}
			else if (num <= 2392565758u)
			{
				if (num != 1601263067u)
				{
					if (num == 2392565758u)
					{
						if (name == "Goat")
						{
							return Game1.content.LoadString("Strings\\StringsFromCSFiles:Utility.cs.5933", new object[0]);
						}
					}
				}
				else if (name == "Dairy Cow")
				{
					return Game1.content.LoadString("Strings\\StringsFromCSFiles:Utility.cs.5927", new object[0]);
				}
			}
			else if (num != 2952921236u)
			{
				if (num == 3444018991u)
				{
					if (name == "Pig")
					{
						return Game1.content.LoadString("Strings\\StringsFromCSFiles:Utility.cs.5948", new object[0]);
					}
				}
			}
			else if (name == "Sheep")
			{
				return Game1.content.LoadString("Strings\\StringsFromCSFiles:Utility.cs.5942", new object[0]);
			}
			return "";
		}
				...
				if (num != 292886277u)
				{
					if (num != 613168024u)
					{
						if (num == 889009852u)
						{
							if (name == "Chicken")
							{
								return Game1.content.LoadString("Strings\\StringsFromCSFiles:PurchaseAnimalsMenu.cs.11334", new object[0]) + Environment.NewLine + Game1.content.LoadString("Strings\\StringsFromCSFiles:PurchaseAnimalsMenu.cs.11335", new object[0]);
							}
						}
					}
					else if (name == "Duck")
					{
						return Game1.content.LoadString("Strings\\StringsFromCSFiles:PurchaseAnimalsMenu.cs.11337", new object[0]) + Environment.NewLine + Game1.content.LoadString("Strings\\StringsFromCSFiles:PurchaseAnimalsMenu.cs.11335", new object[0]);
					}
				}
				else if (name == "Rabbit")
				{
					return Game1.content.LoadString("Strings\\StringsFromCSFiles:PurchaseAnimalsMenu.cs.11340", new object[0]) + Environment.NewLine + Game1.content.LoadString("Strings\\StringsFromCSFiles:PurchaseAnimalsMenu.cs.11335", new object[0]);
				}
			}
			else if (num <= 2392565758u)
			{
				if (num != 1601263067u)
				{
					if (num == 2392565758u)
					{
						if (name == "Goat")
						{
							return Game1.content.LoadString("Strings\\StringsFromCSFiles:PurchaseAnimalsMenu.cs.11349", new object[0]) + Environment.NewLine + Game1.content.LoadString("Strings\\StringsFromCSFiles:PurchaseAnimalsMenu.cs.11344", new object[0]);
						}
					}
				}
				else if (name == "Dairy Cow")
				{
					return Game1.content.LoadString("Strings\\StringsFromCSFiles:PurchaseAnimalsMenu.cs.11343", new object[0]) + Environment.NewLine + Game1.content.LoadString("Strings\\StringsFromCSFiles:PurchaseAnimalsMenu.cs.11344", new object[0]);
				}
			}
			else if (num != 2952921236u)
			{
				if (num == 3444018991u)
				{
					if (name == "Pig")
					{
						return Game1.content.LoadString("Strings\\StringsFromCSFiles:PurchaseAnimalsMenu.cs.11346", new object[0]) + Environment.NewLine + Game1.content.LoadString("Strings\\StringsFromCSFiles:PurchaseAnimalsMenu.cs.11344", new object[0]);
					}
				}
			}
			else if (name == "Sheep")
			{
				return Game1.content.LoadString("Strings\\StringsFromCSFiles:PurchaseAnimalsMenu.cs.11352", new object[0]) + Environment.NewLine + Game1.content.LoadString("Strings\\StringsFromCSFiles:PurchaseAnimalsMenu.cs.11344", new object[0]);
			}
			return "";
		}
