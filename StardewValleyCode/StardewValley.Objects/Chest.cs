	...
	public class Chest : StardewValley.Object
	{
		...
		public void dumpContents()
		{
			...
			if (this.chestType.Equals("Monster"))
			{
				...
				Game1.addHUDMessage(new HUDMessage(Game1.content.LoadString("Strings\\StringsFromCSFiles:Chest.cs.12531", new object[0]), Color.Red, 3500f));
			}
			else
			{
		...
		public override bool checkForAction(Farmer who, bool justCheckingForActivity = false)
		{
			...
			else if (!this.playerChest)
			{
				...
				else if (this.currentLidFrame == 503 && this.items.Count > 0)
				{
					...
					{
						int arg_15A_0 = (this.items[0] as StardewValley.Object).ParentSheetIndex;
					}
				}
			}
